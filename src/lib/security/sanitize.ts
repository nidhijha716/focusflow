 ...
 *
 * Scope: 04_Security_and_Access.pdf ù5, ù10 ù "Avoid dangerouslySetInnerHTML
 * for task/user-entered text" and "Test XSS payloads in task title/description
 * fields."
 *
 * IMPORTANT: The primary XSS defense is architectural, not this file ù
 ...
 * `dangerouslySetInnerHTML` ù React already escapes the returned string when
